	...
	<div id="templatemo_container">
        ...
        <div id="templatemo_menu">
     	<ul>
            ...
            <li><a href="#" target="_parent">Solutions</a></li>
    ...
    <div id="templatemo_header_banner">
    	<div id="templatemo_header">
        	<div id="templatemo_sitetitle">
            	City<span>Indore</span>            </div>
      <div id="templatemo_tagline">For Visit and Enjoy</div>
        </div>
        <div id="templatemo_banner">
        	<div id="templatemo_bannertext">
            	Let's Come<br /><span>For Enjoyment</span><br />
            	together
            </div>
        </div>
    </div>
    ...
    <div id="templatemo_content">
    	...
    	<div id="templatemo_leftcolumn">
        	<div class="login_form">
                ...
                <form method="get" action="#" onsubmit="checkLogin()">
                    <div class="form_row"><label>Email</label><input name="em" type="text" class="inputfield" id="email_addremss" maxlength="60"/>
              </div>
                    <div class="form_row"><label>Password</label><input name="pw" type="password" class="inputfield" id="password" maxlength="60"/>
              </div>
              <div class="form_row"><label><a href="register.jsp">Sign Up</a>Type</label><select name="ty" id="ty">
                           <%
...
<a href="#"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_rightcolumn">
        	<div class="onecolumn">
                ...
                <p> <img src="images/image(130x130).jpg" alt="image" />
            ...
            <div class="twocolumn">
	            <div class="twocolumn_box">
                    <h1>Who We Are</h1>
                    <p>
                        <img src="images/image(70x70).jpg" alt="image" />
            ...
            <div id="gallery">
                ...
                <div class="gallery_column">
                	<img src="images/image(160x60).jpg" alt="image 1" />
                ...
                <div class="gallery_column">
	                <img src="images/image(160x60).jpg" alt="image 2" />
                ...
                <div class="gallery_column">
	                <img src="images/image(160x60).jpg" alt="image 3" />
    ...
    <div id="templatemo_footer">
        ...
        Copyright © 2014 <a href="#"><strong>Universal informatics,indore</strong></a> | 
        <a href="#" target="_parent">Java Student</a> by <a href="#" target="_parent">java 5 to 6 Batch</a>	</div>
    </div>
    <!-- Container close -->
